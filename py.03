...
paevade_arv= 55
oobimise_hind= 30.5
print("Minu reis",sihtkoht,"kestab",paevade_arv,"päeva ja üks öö maksab",oobimise_hind,"eurot.")
#teksti liitmiseks kasutan koma
...
hindamisskoor= 10.0
#teksti liitmiseks +
print("Minu lemmikraamat"+raamatu_pealkiri+" ,mis on "+str(lehekylgede_arv)+" lehekülge pikk ja mille ma hindan "+str(hindamisskoor)+" punktiga.")
